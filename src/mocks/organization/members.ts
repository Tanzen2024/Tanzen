...
export const members: Member[] = [
  ...
  {
    id: 'M-002', tenantId: 'T-002', firstName: 'Mamadou', lastName: 'Sow', gender: 'male', birthDate: '1982-09-23', nationality: 'Sénégalaise', idNumber: 'SN-283-09-1982', occupation: 'Artisan', email: 'mamadou.sow@email.sn', phone: '+221 76 234 56 78', address: '45 Av. Général de Gaulle, Thiès', joinedAt: '2022-01-25', status: 'active', tenantName: 'Tontine Horizon',
  ...
  {
    id: 'M-003', tenantId: 'T-003', firstName: 'Aïssatou', lastName: 'Bâ', gender: 'female', birthDate: '1990-12-05', nationality: 'Sénégalaise', idNumber: 'SN-905-12-1990', occupation: 'Enseignante', email: 'aissatou.ba@email.sn', phone: '+221 78 345 67 89', address: '78 Quai Louis Faidherbe, Saint-Louis', joinedAt: '2021-11-12', status: 'active', tenantName: 'Mutuelle Teranga',
  ...
  {
    id: 'M-007', tenantId: 'T-002', firstName: 'Khadija', lastName: 'Mbaye', gender: 'female', birthDate: '1992-07-14', nationality: 'Sénégalaise', idNumber: 'SN-292-07-1992', occupation: 'Infirmière', email: 'khadija.mbaye@email.sn', phone: '+221 78 789 01 23', address: '45 Av. Général de Gaulle, Thiès', joinedAt: '2022-02-10', status: 'active', tenantName: 'Tontine Horizon',
    positions: [],
