...
export const notifications: Notification[] = [
  { id: 'N-001', tenantId: 'T-005', userId: 'U-001', type: 'workflow', title: 'Approbation en attente', message: 'La demande AP-004 · Awa Cissé (540 000 FCFA) attend votre décision finale.', priority: 'high', read: false, createdAt: '2026-08-12T08:15:00', source: 'credit', link: '/finance/transactions' },
  { id: 'N-002', tenantId: 'T-003', userId: 'U-001', type: 'loan', title: 'Remboursement en retard', message: 'Ibrahima Sarr · prêt L-005 · retard de 16 jours, 51 750 FCFA restants.', priority: 'high', read: false, createdAt: '2026-08-11T10:30:00', source: 'credit', link: '/finance/transactions' },
  ...
  { id: 'N-005', tenantId: 'T-005', userId: 'U-001', type: 'tontine', title: 'Période bientôt terminée', message: 'Tontine Avenir · La période en cours approche de sa date de fin.', priority: 'low', read: true, createdAt: '2026-08-05T11:00:00', source: 'tontines', link: '/tontines/TON-002/periods/PER-002' },
  { id: 'N-006', tenantId: 'T-001', userId: 'U-001', type: 'contribution', title: 'Cotisation reçue', message: 'Fatou Ndiaye a réglé sa cotisation du cycle 4 · Tontine Horizon (50 000 FCFA).', priority: 'low', read: true, createdAt: '2026-08-08T16:45:00', source: 'finance', link: '/finance/transactions' },
  ...
  { id: 'N-010', tenantId: 'T-002', userId: 'U-001', type: 'loan', title: 'Prêt décaissé', message: 'Le prêt L-002 · Mamadou Sow (1 200 000 FCFA) a été décaissé.', priority: 'low', read: true, createdAt: '2026-07-10T10:00:00', source: 'credit', link: '/finance/transactions' },
