...
export const workflowRequests: WorkflowRequest[] = [
   ...
   * que Fiscal Year, sans lien avec leur contenu métier précis. Référencent désormais
   * `WD-008` (reconstruction complète du module Tontines — remplace l'ancien `WD-006`,
   * lui-même une reprise historique d'un `WD-002` « Ouverture de cycle » déjà supprimé).
   */
  {
    id: 'WR-004', tenantId: 'T-005', workflowDefinitionId: 'WD-008', domain: 'tontines', entityType: 'beneficiaryPermutation', entityId: 'BPM-003', entityLabel: 'Tontine Avenir · Permutation', requestedBy: 'Awa Cissé', requestedAt: '2026-06-25', status: 'approved', currentStepOrder: 2,
    steps: [
  ...
  {
    id: 'WR-005', tenantId: 'T-001', workflowDefinitionId: 'WD-008', domain: 'tontines', entityType: 'beneficiaryPermutation', entityId: 'BPM-005', entityLabel: 'Coopérative Sutura · Permutation', requestedBy: 'Cheikh Diop', requestedAt: '2026-08-10', status: 'pending', currentStepOrder: 1,
    steps: [
