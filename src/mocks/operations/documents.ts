...
export const documents: DocumentRecord[] = [
  ...
  { id: 'DOC-005', tenantId: 'T-001', name: 'PV Assemblée Générale 2026.pdf', category: 'minutes', mimeType: 'application/pdf', sizeKb: 780, uploadedBy: 'Aïssatou Bâ', uploadedAt: '2026-06-16', entityType: 'assembly', entityId: 'AS-001', entityLabel: 'AG 2026', shared: true },
