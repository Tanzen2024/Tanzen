...
export const auditEvents: AuditEvent[] = [
  ...
  { id: 'AUD-006', tenantId: 'T-001', timestamp: '2026-06-15T18:00:00', actorId: 'U-002', actorName: 'Fatou Ndiaye', module: 'governance', action: 'governance.create', eventType: 'action', resourceType: 'assembly', resourceId: 'AS-001', resourceLabel: 'AG 2026', status: 'success', sensitive: false, correlationId: 'COR-2026-0205' },
