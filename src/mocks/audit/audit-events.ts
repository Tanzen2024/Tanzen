...
export const auditEvents: AuditEvent[] = [
  ...
  { id: 'AUD-004', tenantId: 'T-001', timestamp: '2026-01-05T09:00:00', actorId: 'U-001', actorName: 'Amadou Mbaye', module: 'tontines', action: 'tontines.create', eventType: 'action', resourceType: 'tontine', resourceId: 'TON-004', resourceLabel: 'Coopérative Sutura', status: 'success', sensitive: false, correlationId: 'COR-2026-0203' },
  ...
  { id: 'AUD-011', tenantId: 'T-002', timestamp: '2026-08-08T16:45:00', actorId: 'U-002', actorName: 'Fatou Ndiaye', module: 'finance', action: 'contributions.read', eventType: 'action', resourceType: 'contribution', resourceId: 'FC-001', resourceLabel: 'Cotisation · Fatou Ndiaye', status: 'success', sensitive: false, correlationId: 'COR-2026-0209' },
  ...
  { id: 'AUD-013', tenantId: 'T-001', timestamp: '2026-08-10T08:00:00', actorId: 'U-003', actorName: 'Cheikh Diop', module: 'tontines', action: 'beneficiaries.manage', eventType: 'action', resourceType: 'occurrenceBeneficiary', resourceId: 'TB-001', resourceLabel: 'Coopérative Sutura · Tour 1', status: 'success', sensitive: false, correlationId: 'COR-2026-0211' },
